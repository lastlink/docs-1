...
<caption><sup>✝</sup>High-level user permissions only</caption>
<caption><sup>✝✝</sup>Often requires significant explanation or training</caption>
...
<caption>Example Schema: _Project Management_</caption>
```
database
├── projects
│   ├── id
